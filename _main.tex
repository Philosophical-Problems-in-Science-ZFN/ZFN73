...
\addbibresource{REV_Mscislawski/Mscislawski.bib}
...
%------------------------------Theorem envs definitions for Olszewski's paper----------------------

%---New enviroment with proof-like qed symbol
\newcommand{\newmarkedtheorem}[1]{%
	\newenvironment{#1}
...
%---Qed symbol after last word in the line
\DeclareRobustCommand{\qed}{%
  \ifmmode%
  \else \leavevmode\unskip\penalty9999 \hbox{}\nobreak%\hfill
  \fi
  \space\hbox{\qedsymbol}}
...
\newtheorem{proposition}[theorem]{Corollary}


\theoremstyle{definition} \newmarkedtheorem{definition}{Definition}


%---theorem with custom numbering/labelling
...
\input{ART_Dodig-Crnkovic/Dodig-Crnkovic.tex}
\input{ART_Toscano/Toscano.tex}
\input{ART_Martin/Martin.tex}
\input{ART_Noh/Noh.tex}
\input{ART_Mscislawski/Mscislaw.tex}
\input{ART_Sekrst/Sekrst.tex}
\input{ART_Soloducha/Soloducha.tex}
\input{ART_Krzanowski_Polak/Krzanowski_Polak.tex}
...
\input{ESS_Olszewski/Olszewski.tex}
\input{ESS_Trzesicki/Trzesicki.tex}
...
\input{REV_Polak2/Polak2.tex}
\input{REV_Polak1/Polak1.tex}
